...
import com.ijse.apexbuildingsolution.apex_building_solution.bo.custom.*;
...
public class addprojectWantedController implements Initializable {
...
//    private final AddProjectWantedModel ADDPROJECTWANDEMODEL = new AddProjectWantedModel();
    private final AddProjectWantedFormBO ADDPROJECTWANTEDFORMBO = (AddProjectWantedFormBO) BOFactory.getInstance().getBO(BOFactory.BOType.ADDPROJECTWANTED);

    ProjectFormBO projectFormBO = new ProjectFormBOImpl();
    ProjectMaterialFormBO projectMaterialFormBO = new ProjectMaterialFormBOImpl();
    MachineProjectBO machineProjectBO = new MachineProjectBOImpl();
    MachineFormBO machineFormBO = new MachineFormBOImpl();
    ...
    private final MachineDAO MACHINEDAO = new MachineDAOImpl();
...
//        }
    ...
    private void loadMachineId() throws SQLException {
        ArrayList<String> machineIds = MACHINEDAO.getAllMachineIds();
    ...
    private void loadMaterialId() throws SQLException {
        ArrayList<String> materialIds = MATERIALDAO.getAllMaterialIds();
        ObservableList<String> observableList = FXCollections.observableArrayList();
    ...
    void machineIdOnAction(ActionEvent event) throws SQLException { // Combo box
        ...
        if(machine != null){
            lblMachineNameShow.setText(machine.getMachineId());
            lblMachineStatusShow.setText(machine.getStatus());
            lblMachineAvailability.setText(String.valueOf(machine.isAvailability()));
            lblMachineQtyOnHandShow.setText(String.valueOf(machine.getQtyOnHand()));
        }
    }
    ...
    void materialIdOnAction(ActionEvent event) throws SQLException {
        ...
        Materials materials = MATERIALDAO.findById(selectedMaterialId);

        if(materials != null){
            lblMaterialNameShow.setText(materials.getMaterialId());
            lblAmmountShow.setText(String.valueOf(materials.getAmount()));
            lblSupplierIdShow.setText(materials.getSuplierId());
            lblModelNumberShow.setText(materials.getModelNumber());
            lblQtyOnHandDB.setText(String.valueOf(materials.getQtyOnHand()));
        }
    }
   ...
   //     MaterialsDto selectedMaterialDto = new MaterialsDto();
    ...
    void placeOnAction(ActionEvent event) throws SQLException {
        ...
        String userId = datas.getUserId();
            ...
            boolean isSaved = ADDPROJECTWANTEDFORMBO.saveProject(addProjectWantedDto);
